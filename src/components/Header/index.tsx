    ...
    <header className="relative h-[50px] sm:h-[80px]">
      {barTransitions(
        (barStyles, item) =>
          item && (
            <animated.div
              className="fixed w-full h-[50px] sm:h-[80px] top-0 z-10 bg-slate-50 sm:bg-slate-50/70 dark:bg-zinc-900 sm:dark:bg-zinc-900/50 backdrop-blur sm:border-b border-zinc-400/10"
              style={barStyles}
            >
              <div className="container h-full flex items-center justify-between">
                ...
                <div className="hidden sm:flex relative flex items-center gap-4">
                  <a href={'/'}>
                    <img
                      className="w-[45px] align-middle dark:invert"
                      src={config.logo}
                      alt="logo"
                    />
                  </a>
